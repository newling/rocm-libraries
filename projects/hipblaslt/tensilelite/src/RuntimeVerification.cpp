...
extern "C" void
    hipblaslt_tensilelite_runtime_verification_set_context(char const* launchId,
                                                           ...
                                                           uint64_t    ordinal)
{
    TensileLite::setRuntimeVerificationContext(launchId == nullptr ? "" : launchId,
                                               roctxRange == nullptr ? "" : roctxRange,
                                               ordinal);
}

extern "C" void hipblaslt_tensilelite_runtime_verification_clear_context()
{
    TensileLite::clearRuntimeVerificationContext();
}
